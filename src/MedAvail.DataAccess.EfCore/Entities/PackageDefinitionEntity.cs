...
/// <summary>
/// EF Core entity for dbo.package_definition (MedAvailPackageManagementDb).
/// Database-first mapping via data annotations. AuditID_MA is the SQL Server
/// rowversion, mapped as a concurrency token.
/// </summary>
